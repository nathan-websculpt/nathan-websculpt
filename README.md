...
- NPCs that help you with your tasks
- beekeeping
- fertilizers which intelligently alter harvest-yields
- a water system
- fast-travel
- the ability to buy and sell in the store
...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=solidity,react,nextjs,ts,js,tailwind,graphql,postgres,rust,c" />
  </a>
</p>
...
- [Crowd Fund v5](https://github.com/nathan-websculpt/crowd-fund-v5) | Like v4, but with Account Abstraction (uses a subgraph)
- [Crowd Fund v1](https://github.com/nathan-websculpt/crowd-fund) | First iteration of the Crowd Fund (does not use a subgraph)
